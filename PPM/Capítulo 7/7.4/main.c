...
void main(void)
{
    ...
    /* Incorrecto. Ambas lecturas generan un error en la ejecución del programa. Para que un apuntador de tipo cadena de caracteres se pueda utilizar con lafunción de lectura gets, es necesario inicializarlo como se hace en la siguiente instrucción. */
    char *cad1 = "";
    gets(cad1);
